...
$lang = array_merge($lang, array(
	'ACP_WELCOMEROBOT_MOD_TITLE'					=> 'Sujet de bienvenue',
	...
	'ACP_WELCOMEROBOT_CONFIG_USERNAME'				=> 'Nom du robot',
	'ACP_WELCOMEROBOT_CONFIG_USERNAME_EXPLAIN'		=> 'Nom qui sera attribué au robot, auteur des sujets.',
	...
	'ACP_WELCOMEROBOT_CONFIG_HELP'					=> 'Note :<br />vous pouvez utiliser `%user`, `%robot` et `%board` pour afficher dans le titre et le contenu du sujet, le nom du dernier utilisateur enregistré, le nom du robot et le titre du forum.',
	'ACP_WELCOMEROBOT_SETTINGS'						=> 'Paramètres',
	'ACP_WELCOMEROBOT_SUCCESS'						=> 'Paramètres sauvegardés avec succès.',
	'ACP_WELCOMEROBOT_ERROR'						=> 'Le nom d’utilisateur attribué au robot est invalide.',
